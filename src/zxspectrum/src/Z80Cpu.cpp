    ...
    void Z80Cpu::mainQuadrant0()
    {
        ...
        else if (z == 0b010)
        {
            ...
            case 0b000:
                ...
                m_registers.wz = static_cast<uint16_t>(((m_registers.bc.low + 1) & 0xff) | (m_registers.af.high << 8));
                break;
            case 0b001:
                // LD A, (BC)
            ...
            case 0b010:
                ...
                m_registers.wz = static_cast<uint16_t>(((m_registers.de.low + 1) & 0xff) | (m_registers.af.high << 8));
                break;
            case 0b011:
                // LD A, (DE)
